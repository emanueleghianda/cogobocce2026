...
export default async function ArchivedGroupsPage() {
  ...
  return (
    <>
      <PageHero eyebrow="Archivio · Fase a gironi" title="Gironi e classifiche" description="Le classifiche definitive dei quattro gironi del Doppio 2K26." />
          ...
          return (
            <article className="group-card" key={standings.groupCode}>
              ...
              <div className="group-card__body">
                ...
                <StandingsTable standings={standings} format="double" />
