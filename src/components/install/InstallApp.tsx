...
export function InstallApp() {
  ...
  async function shareInstallLink() {
    setMessage("");
    const data = {
      title: "Installa Bocce Cogoleto",
      text: "Installa sul telefono l'app dei Tornei di Bocce di Cogoleto.",
  ...
  return (
    <div className="install-card">
      ...
      <div>
        ...
        <h2>{installed ? "App già installata" : "Installa Bocce Cogoleto"}</h2>
        <p>
