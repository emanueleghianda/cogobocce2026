...
export const metadata: Metadata = {
  ...
  description: "Installa sul telefono l'app del Torneo di Bocce Doppio Cogoleto 2K26.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Aggiungi Bocce Cogoleto 2K26 alla schermata Home del telefono. È gratuita e non richiede App Store o Google Play."
      />
