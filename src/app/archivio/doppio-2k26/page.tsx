...
export default async function ArchivedDoubleHomePage() {
  ...
  return (
    <>
      <PageHero
        eyebrow={`${data.tournament.season_label} · Archivio`}
        title={data.tournament.title}
        description="Edizione conclusa: tutti i dati ufficiali restano consultabili."
        logo
        logoSrc={data.tournament.logo_path}
        logoAlt={`Logo ${data.tournament.title}`}
      >
        <div className="hero-actions">
          <Link className="button button--primary" href="/archivio/doppio-2k26/gironi"><ListChecks size={19} aria-hidden="true" /> Gironi e classifiche</Link>
          <Link className="button button--outline" href="/archivio/doppio-2k26/partite"><CalendarDays size={19} aria-hidden="true" /> Tutte le partite</Link>
          <Link className="button button--outline" href="/archivio/doppio-2k26/fase-finale"><Trophy size={19} aria-hidden="true" /> Fase finale</Link>
        </div>
      </PageHero>
      ...
      <section className="section container">
        <div className="section-heading"><div><p className="eyebrow">Risultati definitivi</p><h2>Ultime partite</h2></div><Link className="button button--outline" href="/archivio/doppio-2k26/partite">Calendario completo</Link></div>
      ...
      <section className="section container">
        <div className="section-heading"><div><p className="eyebrow">Podio del Doppio 2K26</p><h2>Classifica finale</h2></div></div>
