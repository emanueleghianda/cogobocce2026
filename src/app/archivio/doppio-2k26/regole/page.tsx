...
export default function ArchivedRulesPage() {
  return (
    <>
      <PageHero eyebrow="Archivio · Regolamento ufficiale" title="Come si giocava" description="Formato, punteggi e criteri di qualificazione del Torneo di Bocce Doppio Cogoleto 2K26." />
      <section className="section container rules-grid">
        <article className="panel panel--gold"><CircleDot color="#D71920" aria-hidden="true" /><h2>Fase a gironi</h2><ul className="rules-list"><li>4 gironi fino a 4 coppie.</li><li>Ogni coppia affronta tutte le altre del girone.</li><li>Le partite si giocano ai 10 punti.</li><li>Passano le prime 2 di ogni girone.</li></ul></article>
