...
export const metadata: Metadata = {
  ...
  description: "Classifica ufficiale di bocce degli anni '20 precedente al Torneo di Bocce Singolo Cogoleto 2K26.",
};
...
export default async function RankingPage() {
  ...
  return (
    <>
      <PageHero eyebrow="Albo storico" title="RANKING UFFICIALE BOCCE ANNI '20" description="Classifica ufficiale precedente al Torneo di Bocce Singolo Cogoleto 2K26" logo logoSrc={data.tournament.logo_path} logoAlt={`Logo ${data.tournament.title}`} />
      ...
      <section className="section--tight container">
        <div className="table-scroll table-scroll--ranking" tabIndex={0} aria-label="Ranking ufficiale bocce anni '20">
          <table className="ranking-table">
            ...
            <tbody>{data.historicalRanking.map((entry) => {
