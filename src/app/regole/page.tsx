...
export default function RulesPage() {
  return (
    <>
      <PageHero eyebrow="Regolamento ufficiale" title="Come si gioca" description="Formato, punteggi e criteri di qualificazione del Torneo di Bocce Singolo Cogoleto 2K26." />
      <section className="section container rules-grid">
        <article className="panel panel--gold"><CircleDot color="#D71920" aria-hidden="true" /><h2>Fase a gironi</h2><ul className="rules-list"><li>4 gironi da 4 giocatori.</li><li>Ogni giocatore disputa 3 partite.</li><li>Le partite si giocano ai 10 punti.</li><li>Passano i primi 2 di ogni girone.</li></ul></article>
        <article className="panel panel--gold"><ShieldCheck color="#008F45" aria-hidden="true" /><h2>Criteri di classifica</h2><ol className="rules-list"><li>Maggior numero di vittorie.</li><li>Migliore differenza punti.</li><li>Scontro diretto.</li></ol><p>Le parità fra tre o più giocatori con vittorie e differenza identiche vengono risolte ufficialmente dall’organizzazione.</p></article>
